...
def plot_bounding_box(fig, min_corner, max_corner, color='red', width=10, legend_name=None):
    """
    ...
    edges = [
        ...
        ([min_corner[0], min_corner[1], max_corner[2]], [max_corner[0], min_corner[1], max_corner[2]]),
        ([min_corner[0], min_corner[1], max_corner[2]], [min_corner[0], max_corner[1], max_corner[2]]),
        ([min_corner[0], max_corner[1], min_corner[2]], [min_corner[0], max_corner[1], max_corner[2]]),
    ...
    for i, edge in enumerate(edges):
        fig.add_trace(go.Scatter3d(
            ...
            name=legend_name if i == 0 else None  # Use legend_name for the first edge
        ))

def plot_3d_pointcloud(point_xyz, point_rgb, bboxes=None, instance_names=None, max_points=250_000, seg_onehot=None):
    """
    ...
    scatter = go.Scatter3d(
        ...
        marker=dict(
            size=4,
            color=point_colors.numpy(),  # Use computed colors
            opacity=0.9
        )
    )
    ...
    if bboxes is not None:
        for idx, bbox in enumerate(bboxes):
            ...
            plot_bounding_box(fig, min_corner, max_corner, legend_name=legend_name, color=color)
